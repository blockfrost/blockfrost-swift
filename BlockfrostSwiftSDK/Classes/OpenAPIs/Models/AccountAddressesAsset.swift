...
public final class AccountAddressesAsset: Codable, Hashable {
    ...
    public static func == (lhs: AccountAddressesAsset, rhs: AccountAddressesAsset) -> Bool {
        lhs.unit == rhs.unit &&
