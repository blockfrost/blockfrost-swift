...
open class APIURLRequest : APIRequest {
    ...
    public init(dataTask: URLSessionDataTask? = nil) {
            ...
            let dataTask = urlSession.dataTask(with: request) { data, response, error in
                ...
                if let taskCompletionShouldRetry = self.taskCompletionShouldRetry {
                    ...
                    taskCompletionShouldRetry(data, response, error) { shouldRetry in
                        ...
                        if shouldRetry {
                            cleanupRequest()
                            let _ = self.execute(apiQueue, completion)
...
public class URLEncoding: ParameterEncoding {
    public func _encode(_ urlRequest: URLRequest, with parameters: [String: Any]?) throws -> URLRequest {
    ...
    public func encode(_ urlRequest: URLRequest, with parameters: [String: Any]?) throws -> URLRequest {
        return try _encode(urlRequest, with: parameters)
    }
}

public class FormDataEncoding: ParameterEncoding {
...
public class FormURLEncoding: ParameterEncoding {
    public func _encode(_ urlRequest: URLRequest, with parameters: [String: Any]?) throws -> URLRequest {
